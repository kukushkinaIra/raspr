                ...
                <div>
                    <div className="about_first">
                        ...
                        <div className="about_text">
                            <p>Мы, команда «Алексей Гуревич – консалтинг» помогаем с распределением, перераспределением
                                и прохождением производственной/ преддипломной практики студентам по всей РБ.</p>
                            <p>Мы предлагаем возможность распределения в нашу компанию. Трудоустройство идет без
                                привязки к офису/ дистанционно на 0,1 ставки, и у Вас есть возможность работать по
                                совместительству или договору подряда. Также можно уехать работать, учиться или жить в
                                другую страну.</p>
